...
# 確保專案根目錄寫入 sys.path，解決 Streamlit Cloud 部署 ImportError 問題
...
# Restored Post-Run Summary Metrics
if st.session_state.calculated:
    ...
    st.info(f"ℹ️ {VERSION} 運算完成。請查看 Technical Tests 與 Research Validation 結果。")
